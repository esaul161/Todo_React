...
test("Remove sub ToDo", () => {
  ...
  wrapper.find(".removeSubToDo").first().simulate("click");

  //Cheking the sublist of ToDo the length need to be equal to 0
  expect(wrapper.find(".subList").first().props().children.length).toEqual(0);
});
